...
import { StatusAccount, type AccountRequest, type RegisterKeyPix } from '~/types/account'
import { formatDateToInput, isValidBirthDate, formatToBRLInput } from '~/utils/util'
