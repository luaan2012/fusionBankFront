...
export function Sidebar({
  ...
  const menuItems = [
    ...
    { icon: faBarcode, color: 'text-green-500', label: 'Boletos', onClick: billetsClick, view: 'billets' },
          ...
          {menuItems.map((item, index) => (
            <li key={index}>
              <button
                ...
                className={`flex items-center space-x-3 p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-700 w-full text-left ${item.view === view
