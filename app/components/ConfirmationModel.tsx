...
import { faTimes, faMobileAlt, faClock, faInfoCircle, faCircleNotch } from '@fortawesome/free-solid-svg-icons';
...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({ isOpen, onClose, transferData, onConfirm }) => {
