...
import { translateAccountType, formatNumberAccount, formatToBRL, ActionMapper, formatDateBR } from '~/utils/util'
...
export const AccountSummary = ({ user, investment, card, loadingCard, loadingInvestment, loadingUser }: AccountSummaryProps) => {
