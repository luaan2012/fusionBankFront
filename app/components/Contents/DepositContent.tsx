...
import { ConfirmationModalDeposit } from '../Modals/DepositModal'
...
export const DepositContent = ({ setShowBoletoModal, setShowSuccessModal, setShowErrorToast }: DepositContentProps) => {
