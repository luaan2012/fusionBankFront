...
import type { CreditCard, Invoice } from '~/models/creditCard';
import { formatDateBR, formatToBRL } from '~/utils/utils';
...
const InvoicesContent: React.FC<InvoicesContentProps> = ({ card }) => {
