      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {user ? (
            <div>
              <div className="flex justify-between items-start mb-4">
                ...
                >
                  {'active' === 'active' || !user.status ? 'Ativa' : 'Inativa'}
        ...
        >
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">
                Total investido: {formatToBRL(investment.total)}
              </p>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-300">
                Retornos recentes: <span className="text-green-600 dark:text-green-400">{formatToBRL(investment.returns)}</span>
              </p>
            </div>
          </div>
          <button
