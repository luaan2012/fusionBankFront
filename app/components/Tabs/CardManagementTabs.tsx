...
import { InvoicesContent } from '../Contents/InvoicesContent'
import { LimitsContent } from '../Contents/LimitsContent'
import { TransactionsContent } from '../Contents/TransactionsContext'
...
export const CardManagementTabs: React.FC<CardManagementTabsProps> = ({ onAdjustLimit, onTempBlock, card }) => {
